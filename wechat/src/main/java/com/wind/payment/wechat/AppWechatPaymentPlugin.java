...
public class AppWechatPaymentPlugin extends AbstractWechatPaymentPlugin {
    ...
    public PrePaymentOrderResponse preOrder(PrePaymentOrderRequest request) {
        ...
        try {
            ...
            throw new PaymentTransactionException(DefaultExceptionCode.COMMON_ERROR, String.format("微信 App 支付交易异常，transactionNo = %s。", request.getTransactionSn()), exception);
        }
        return result;
    }
}
